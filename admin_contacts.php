...
<section class="messages">
   ...
   ?>
   <div class="box">
      <p> id pengguna : <span><?= $fetch_message['user_id']; ?></span> </p>
      ...
      <a href="admin_contacts.php?delete=<?= $fetch_message['id']; ?>" onclick="return confirm('hapus pesan ini?');" class="delete-btn">hapus</a>
   </div>
   <?php
         }
      }else{
