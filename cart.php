...
<section class="shopping-cart">
   ...
   <form action="" method="POST" class="box">
      <a href="cart.php?delete=<?= $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('Hapus dari keranjang?');"></a>
      ...
      <div class="flex-btn">
         ...
         <input type="submit" value="Perbarui" name="update_qty" class="option-btn">
      </div>
      <div class="sub-total"> Subtotal : <span>Rp<?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>,-</span> </div>
   </form>
   <?php
