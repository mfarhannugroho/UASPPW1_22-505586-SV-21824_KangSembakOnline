...
<section class="p-category">
   ...
   <a href="category.php?category=buah-buahan">buah-buahan</a>
   <a href="category.php?category=sayur">sayur</a>
   <a href="category.php?category=ikan">ikan</a>
   <a href="category.php?category=daging">daging</a>
...
<section class="products">
   ...
   <form action="" class="box" method="POST">
      ...
      <input type="submit" value="Tambahkan ke Wishlist" class="option-btn" name="add_to_wishlist">
